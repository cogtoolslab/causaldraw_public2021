 ...
 * 
 * IMPORTANT NOTE: This was edited to display the machine then sketch (simultaneously) and after a spacebar press, then display the segmented reference image
 * RT is now calculated between the display of the sketch to the spacebar press
 **/
...
jsPsych.plugins["image-keyboard-response"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += "<p>Keep your fingers on the numbers 1-4 and spacebar.</p>"
    ...
    if (trial.phase == "practice") {
      ...
      html += '<div id="prompt" class="instructions">'
      html += '<p>Which part of the machine needs to be moved to turn the light on?<p>'
      html += '</div>' // close instructions
    };
    ...
    setTimeout(function() {
      ...
      showSketch();
    }, 5000); // close setTimeout — show sketch for 5s
