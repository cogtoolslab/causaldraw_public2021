 ...
 * 
 * IMPORTANT NOTE: This plugin allows 8 ROI responses.
 **/
...
jsPsych.plugins["image-keyboard-response"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    }; // close showMachine – show orig machine image for 10s
   ...
   }, 15000); // close setTimeout — note! this 15000ms is the length of time of presented sketch and machine
