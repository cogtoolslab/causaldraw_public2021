...
```{r message = FALSE}
## original batch run on mturk
orig_data1 <- read_csv("../results/csv/causaldraw_annotations_processed_data.csv") 
## collected more annotations to resolve some majority vote issues on SONA
orig_data2 <- read_csv("../results/csv/causaldraw_annotation_patch2.csv") 
## collected 2 more annotations for missing annotations for levers_1 on Prolific
orig_data3 <- read_csv("../results/csv/causaldraw_annotation_patch3.csv") 

#combine datasets as needed into full dataset
orig_data <- mget(paste0('orig_data', c('1', '2', '3'))) %>%
   dplyr::bind_rows()
...
reference_A <- read_csv("../results/csv/reference/causaldraw_annotations_label_data_gears1reference.csv")
reference_B <- read_csv("../results/csv/reference/causaldraw_annotations_label_data_gears2reference.csv")
reference_C <- read_csv("../results/csv/reference/causaldraw_annotations_label_data_levers1reference.csv")
reference_D <- read_csv("../results/csv/reference/causaldraw_annotations_label_data_levers2reference.csv")
reference_E <- read_csv("../results/csv/reference/causaldraw_annotations_label_data_pulleys1reference.csv")
reference_F <- read_csv("../results/csv/reference/causaldraw_annotations_label_data_pulleys2reference.csv")
...
allsketches <- read_csv("../results/csv/reference/allsketches.csv") 
...
## Save out data
```{r}
#subset sketches that have been annotated by 3 annotators
final_data <- data %>%
  group_by(sketchID) %>%
  mutate(count = match(gameID, unique(gameID))) %>%
  filter(count >= 3)

write.csv(final_data, '../results/csv/causaldraw_annotation_final_data_public.csv')
...
```{r}
#4. Do people spend more time drawing causal elements in the explanation condition?
