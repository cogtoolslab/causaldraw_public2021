...
jsPsych.plugins["image-button-response"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add sketch
    html += '<img src="'+trial.sketch_nav+'" id="jspsych-image-button-response-stimulus" style="';
    ...
    function after_response(choice) {
      ...
      // convert keycodes of pressed values into semantically meaningful descriptions
      if (response.button == 0) {
        selected_button = 'Pull'
      } else if (response.button == 1) {
        selected_button = 'Rotate'
      } else if (response.button == 2) {
        selected_button = 'Push'
      } else if (response.button == 3) {
        selected_button = "unintelligible"
      };

      if (trial.response_ends_trial) {
        end_trial();
      }
    }; // close after_response function
    ...
    function end_trial() {
      ...
      display_element.innerHTML = "<p>Fetching another drawing for you!";
      jsPsych.finishTrial(trial_data);
    }; // close end_trial function
